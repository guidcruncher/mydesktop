  ...
  <div class="sunmoon-widget-container" :class="{ 'sunmoon-loading-shim': loading }">
    ...
    <div class="sunmoon-header">
      <div class="sunmoon-location-group" @click="toggleSearch(true)">
        <div class="sunmoon-location-title">
          {{ city }}
          <svg class="sunmoon-location-icon" viewBox="0 0 24 24"><path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z"/></svg>
        </div>
    ...
    <div class="sunmoon-data-section">
      ...
      <div class="sunmoon-card">
        ...
        <div class="sunmoon-sun-viz">
          <svg viewBox="0 0 200 100" style="width:100%; height:100%; overflow:visible;">
            <!-- Track -->
            <path d="M 20 90 A 80 80 0 0 1 180 90" fill="none" stroke="var(--sunmoon-sun-path)" stroke-width="3" stroke-dasharray="5,5" stroke-linecap="round"/>
            <!-- Progress -->
            <path :d="sunProgressPath" fill="none" stroke="var(--sunmoon-sun-fill)" stroke-width="4" stroke-linecap="round"/>
            <!-- Dot -->
            <circle :cx="sunDotX" :cy="sunDotY" r="8" :fill="sunDotFill" stroke="var(--sunmoon-sun-dot-stroke)" stroke-width="2"/>
            <!-- Horizon -->
            <line x1="10" y1="90" x2="190" y2="90" stroke="var(--sunmoon-border-widget)" stroke-width="1" />
          </svg>
        </div>
      ...
      <div class="sunmoon-card" style="flex-direction: column; justify-content: center;">
        <div class="sunmoon-label" style="position: absolute; top: 16px; left: 16px;">Moon Phase</div>
...
const formattedDate = computed(() => {
  return date.value.toLocaleDateString([], { 
    weekday: 'short', month: 'short', day: 'numeric', timeZone: timezone.value 
  });
});
