...
/* Removed .news-widget-fixed::before (background image layer) as it is now handled via props */
...
.news-widget-fixed :deep(.ui-widget-title) {
  color: white !important; /* Force white for news/image legibility */
